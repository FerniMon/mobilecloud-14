...
public class Video {
	...
	public void removeLiker(String username) {
	...
	public void setLikers(Set<String> likersSet){
		likers = likersSet;
	}
	
	private void incrLikes() {
		likes++;	
	}
	
	private void decrLikes() {
		likes--;
	}
